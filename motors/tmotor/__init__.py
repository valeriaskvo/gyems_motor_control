class TMotorQDD:
    ...
    # add tx_message dict
    # add rx_message dict
    def __init__(self, can_bus = None, device_id = 0x001, rxtx_interface = None):
        ...
        self.commands = {'mot_mode_on':b'\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFC',
    ...
    def bytes_to_state(self, recived_bytes):
        ...
        if recived_bytes:
            ...
            self.state_recv_bytes['vel'] = (recived_bytes[3]<<4)|(recived_bytes[4]>>4)
            self.state_recv_bytes['tor'] = ((recived_bytes[4]&0xF)<<8)|recived_bytes[5]
    ...
    def set_zero(self):
        print(f'You are going to assign a new zero for motor with ID {self.device_id}, press "Y" to continue...\n')
        user_input = input()
